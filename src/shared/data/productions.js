// KALICI mock — GET /api/productions artık gerçek (shared/api/productions.js),
// ama bu dosya hâlâ canlı: getProductionBySlug (ContentSection, GameOfThrones
// sayfası) buradan besleniyor. id/slug/title/genre/synopsis alanları backend
// DTO'suyla örtüşür; posterGradient/theme ise backend'de hiç KARŞILIĞI OLMAYAN,
// salt frontend'e ait sunum verisidir (gerçek API bunları asla dönmeyecek) —
// "API'yi yansıtır" yalnızca ilk grup alan için geçerli.
