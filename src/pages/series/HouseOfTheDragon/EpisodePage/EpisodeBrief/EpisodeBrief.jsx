...
/**
 * Hero'nun altındaki "karar bloğu" — BreakingBad/EpisodeBrief'in BİREBİR
 * aynısı. TEK kasıtlı fark: HotD HBO yapımı olduğu için GoT'taki gibi HBO
 * Max rozeti VAR (kullanıcının verdiği gerçek icons8 asset'i, public/hbo-
 * max-logo.png) — BB'de AMC'nin eşdeğer bir logo asset'i verilmediği için
 * bu rozet yoktu. IMDb puanı gerçek veriyle var olduğu sürece aynen render
 * edilir.
 *
...
export function EpisodeBrief({ episode, seasonNumber, genres, rating }) {
  ...
  // Section görünüme girerken TEK SEFERLİK fade+rise reveal'i, başlıktan
  // içeriğe kademeli.
  useLayoutEffect(() => {
