...
// Severance'ın Atmosphere'inin birebir portu (2026-09-12 rollout). Kendi
// arka planı YOK — HouseOfTheDragon.jsx'teki .intro__backdrop (Hero ile
// PAYLAŞILAN tek görsel) bu section'ın arkasından geçiyor. Accent renk
// YOK — vurgulu metinler arkadaki görselin kendisiyle dolduruluyor
// (background-clip:text), pozisyon her scroll karesinde yeniden hesaplanır
// (bkz. applySharedBgRef) ki soldan-açığa-çıkma animasyonu sırasında
// bayatlamasın.
export default function Atmosphere() {
  ...
  useEffect(() => {
    fetchProductionById('series', 6).then(setSeries);
  }, []);
  ...
  return (
    <section className={styles.atmosphere} ref={sectionRef}>
      ...
      >
        <p ref={eyebrowRef} className={styles.atmosphere__eyebrow}>Fire and Blood</p>
        <h2 ref={headlineRef} className={styles.atmosphere__headline}>
          A dynasty at its height, and the war of succession that will bring it to ruin.
        </h2>
