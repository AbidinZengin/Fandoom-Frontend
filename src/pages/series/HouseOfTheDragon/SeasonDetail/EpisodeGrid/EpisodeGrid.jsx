...
/**
 * Sezonun bölüm listesi — BreakingBad/SeasonDetail/EpisodeGrid ile BİREBİR
 * aynı (standart imza şablonu), sadece route base'i house-of-the-dragon.
 * EpisodePage HOTD için henüz kurulmadı — link hedefi hazır, sayfa ayrı iş.
 */
    ...
    <div aria-label={t('series.episodesHeading')}>
      ...
      <ol className={styles.list} ref={listRef}>
        {episodes.map((ep) => (
          <li key={ep.id}>
            <Link
              to={`/series/house-of-the-dragon/seasons/${seasonNumber}/episodes/${ep.episodeNumber}`}
