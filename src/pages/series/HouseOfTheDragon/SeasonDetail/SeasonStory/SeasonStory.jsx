...
/**
 * Sezonun "derin okuma" bölümü — BreakingBad/SeasonDetail/SeasonStory ile
 * BİREBİR aynı (standart imza şablonu). İçerik backend'den (seasonBlocks)
 * gelir, Accept-Language'e göre tek dile çözümlenmiş olarak.
