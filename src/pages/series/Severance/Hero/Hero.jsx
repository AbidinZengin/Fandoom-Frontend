...
// BreakingBad/HotD Hero'suyla BİREBİR aynı giriş deseni (kullanıcı
// isteği, 2026-09-11): `.hero` ortadan ince bir şeritten kapı gibi
// açılıyor; ARKA (blurlu, çerçeve DIŞI) katman counter-zoom ile oturuyor;
// ÖN (net, çerçeve İÇİ) görsel fade+rise ile beliriyor. Scroll parallax +
// scrub-fade DENENDİ ama kaldırıldı — ikisi de görselin transform'unu
