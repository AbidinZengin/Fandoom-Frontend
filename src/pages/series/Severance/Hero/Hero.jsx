...
// DÜZELTME (manuel): Explore butonu diğer 3 Hero (BreakingBad/HotD/
// Pluribus) ile BİREBİR aynı ok ikonunu kullanır (kullanıcı isteği,
// 2026-09-05: "tüm dizilerde tüm butonlar aynı olsun").
function ArrowIcon() {
  return (
    ...
    <div className={styles.page}>
      ...
      <div className={styles.cardWrap}>
        ...
        <div className={styles.ctaRow}>
          ...
          <button type="button" className={styles.buttonBlock2}>Explore <ArrowIcon /></button>
        </div>
        <Link to="/series/severance" className={styles.logoBlock2}><img src="/src/assets/logos/severance.webp" alt="Severance" /></Link>
      </div>
    </div>
  );
}
