...
export default function Severance() {
  ...
  return (
    <>
      {/* .intro: Hero + Atmosphere'i saran TEK blurlu arka plan (kullanıcı
          isteği, 2026-09-12) — iki ayrı <img> kendi kutusuna göre "cover"
          yapınca aralarında dikiş/yüzey farkı oluşuyordu. Navbar payı
          (-72px) artık burada — Hero kendi payını bırakmıştı. */}
