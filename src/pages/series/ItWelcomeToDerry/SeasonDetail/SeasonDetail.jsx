...
export default function SeasonDetail() {
  ...
  const goToSeason = (target) => {
    if (!target) return;
    armInPageNav();
    navigate(`/series/it-welcome-to-derry/seasons/${target.seasonNumber}`);
  };
      ...
      <div className={styles.page}>
        <section className={styles.hero}>
          ...
          <div className={styles.hero__content}>
            <button type="button" className={styles.hero__back} onClick={() => navigate('/series/it-welcome-to-derry')}>
