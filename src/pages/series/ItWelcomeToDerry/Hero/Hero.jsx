    ...
    const ctx = gsap.context(() => {
      ...
      mm.add('(prefers-reduced-motion: no-preference)', () => {
        if (isCinematicArmed()) {
          ...
          // Kapı-açılma clip-path'i backdrop+Hero'yu SARAN .intro'yu hedefler
          // (Severance'daki düzeltme, 2026-09-12) — backdrop artık Hero'nun
          // dışında (Atmosphere ile paylaşım için), sadece pageRef'i
          // kapatmak backdrop'un kapı aralığı dışında hemen görünmesine
          // (siyah yerine arka planı göstermesine) yol açıyordu.
        ...
        // tetiklenir (Severance ile AYNI teknik/aralık). Görselin kendisi
        // dokunulmuyor.
        gsap.fromTo(
          contentRef.current,
          { opacity: 1, y: 0 },
