...
export default function Hero() {
  ...
  useEffect(() => {
    fetchProductionById('series', 10).then(setSeries7);
  }, []);
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.cardWrap}>
        ...
        <Link to="/series/it-welcome-to-derry" className={styles.brandLogo}>
          <img src="/src/assets/logos/it-welcome-to-derry.webp" alt="IT: Welcome to Derry" />
        </Link>
