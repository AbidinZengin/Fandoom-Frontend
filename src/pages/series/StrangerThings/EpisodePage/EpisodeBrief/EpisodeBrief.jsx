 ...
 * aynısı (standart imza şablonu). Platform-marka rozeti YOK — Stranger
 * Things (Netflix) için eşdeğer bir logo asset'i verilmedi, sahte/placeholder
 * logo üretilmedi (learned-rules [asset], HotD'deki HBO Max rozetiyle
 * AYNI istisna gerekçesi). IMDb puanı gerçek veriyle var olduğu sürece
 * aynen render edilir.
 */
