    ...
    const ctx = gsap.context(() => {
      ...
      mm.add('(prefers-reduced-motion: no-preference)', () => {
        if (isCinematicArmed()) {
          ...
          // Backdrop artık Hero'nun DIŞINDA (From.jsx'teki .intro, Atmosphere
          // ile paylaşılıyor) — kapı hedefi ata konteynere taşındı, aksi
          // halde backdrop kapı aralığının dışında hemen tam görünürdü.
        ...
        // tetiklenir (Severance'daki AYNI teknik/aralık). Görselin kendisi
        // dokunulmuyor.
        gsap.fromTo(
          contentRef.current,
          { opacity: 1, y: 0 },
