...
// GoT'un SeasonRow'unun BİREBİR aynısı (kullanıcı kararı, 2026-08) — artık
// EpisodePage kuruldu (route: /series/breaking-bad/seasons/:seasonNumber/
// episodes/:episodeNumber), episode satırları GoT'taki gibi gerçek <Link>.
//
