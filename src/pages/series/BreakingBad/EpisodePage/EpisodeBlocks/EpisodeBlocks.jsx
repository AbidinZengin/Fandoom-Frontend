...
/**
 * EpisodeBrief'in altındaki derin-analiz scrollytelling'i. GoT'un
 * EpisodeBlocks'unun BİREBİR aynısı (kullanıcı kararı, 2026-08) —
 * fetchEpisodeBlocks production-agnostik olduğu için backend'de BB
