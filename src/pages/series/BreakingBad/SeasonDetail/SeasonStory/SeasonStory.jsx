...
// content alanı backend'de Accept-Language'e göre TEK dile çözümlenir (diğer
// tüm entity'lerle aynı sözleşme) — burada EN/TR seçimi YAPILMAZ, block.content
// olduğu gibi render edilir.
 ...
 * deneme üslubuna uyarlanmış ses. İçerik backend'den (seasonBlocks) gelir,
 * Accept-Language'e göre tek dile çözümlenmiş olarak — bu component artık
 * yerel/EN-only mock'a bağlı değil (2026-08-22'de backend'e taşındı).
 * `photo.episodeNumber`, `episodes` prop'undaki GERÇEK bölüm verisinden
 * (stillImageUrl) o fotoğrafı bulur — sahte görsel yok.
 * Basit fade+y reveal — pin/scroll-scrub mekaniği yok.
 */
