...
import { getSeasonStory } from '../SeasonDetail/SeasonStory/SeasonStory.data';
...
export default function SeasonRoute() {
  ...
  const activeStory = activeSeason ? getSeasonStory(activeSeason.seasonNumber) : null;
      ...
      <div className={styles.bottom}>
        {activeSeason && (
          <div className={styles.focus}>
            ...
            {activeStory?.dek && <p className={styles.focus__dek}>{activeStory.dek}</p>}
            <Link
